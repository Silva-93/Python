""" 
    ...
    @dataclass(init=False)  -> desativa o __init__()
    @dataclass(frozen=False)  -> congela a classe, assim não é possível "setar" atributos
    @dataclass(order=True)  -> Torna possível criar uma ordenação
"""
